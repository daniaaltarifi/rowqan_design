  ...
  return (
    <nav>
      ...
      <ul className={`nav-links ${isOpen ? 'open' : ''}`} onClick={toggleMenu}>
        ...
        <li><Link to={`/${lang}/chalets`}>Chalets</Link></li>
        <li><Link to={`${lang}/events`}>Events</Link></li>
        <li><Link to={`${lang}/lands`}>Lands</Link></li>
        {/* <li><Link to={`${lang}/`}>Contact</Link></li> */}
        <li><Link to={`${lang}/login`}><button className="Login-button">Login</button></Link></li>
        <li> <div
